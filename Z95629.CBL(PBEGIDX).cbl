      ...
      * WS-SUB-DATA DEĞİŞKENİNE ATIYORUZ
           STRING WS-NEW-NAME WS-NEW-LNAME DELIMITED BY SIZE INTO
            WS-FULL-NAME.
           STRING WS-NAME, WS-SURNAME, WS-FULL-NAME, WS-NEW-LNAME
      ...
      * DEĞİŞTİRİYORUZ
           ...
           INSPECT WS-NAME REPLACING ALL LOW-VALUES BY SPACES.
       H207-END. EXIT.
       ...
       H208-WRITE-NEWLNAME.
           ...
           INSPECT WS-SURNAME REPLACING ALL LOW-VALUES BY SPACES.
       H208-END. EXIT.
      ...
      * YENİ VERİYİ YAZMAK İÇİN YENİ DEĞERLERİ HAZIRLIYORUZ
           ...
           MOVE 'H A L I M      GERMIYAN       ' TO WS-TEMP-NAME.
